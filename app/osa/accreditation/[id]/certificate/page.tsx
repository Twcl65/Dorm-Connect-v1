...
export default function CertificatePage() {
  ...
  const loadData = useCallback(async () => {
    if (!id) return;
    try {
      const res = await fetch(`/api/osa/accreditation/${id}`);
      ...
      >
        ...
        <div className="w-full flex flex-col items-center space-y-4 mb-15">
          ...
          <div className="w-full text-center space-y-1">
            <h2 className="text-xs font-bold tracking-wider uppercase">University of Science and Technology of Southern Philippines</h2>
        ...
        {/* Certification Text */}
        <div className="w-full max-w-3xl mx-auto text-sm leading-loose text-justify px-8 mb-5">
